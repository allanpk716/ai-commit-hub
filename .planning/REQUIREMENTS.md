...
- [x] **SI-01**: 应用启动时检测是否已有实例运行 ✅
- [x] **SI-02**: 检测到多实例时，激活现有窗口到前台 ✅
- [x] **SI-03**: 使用 Wails 内置 SingleInstanceLock 机制 ✅
- [x] **SI-04**: 保存和恢复窗口状态（位置、大小） ✅
...
- [x] **TRAY-01**: 双击托盘图标恢复并激活主界面 ✅
- [x] **TRAY-02**: 右键显示上下文菜单（显示/隐藏、检查更新、退出） ✅
- [x] **TRAY-03**: 升级到 lutischan-ferenc/systray v1.3.0 以支持双击 ✅
- [x] **TRAY-04**: 使用 sync.Once 和 atomic.Bool 防止竞态条件 ✅
- [x] **TRAY-05**: 区分"最小化到托盘"和"退出应用"行为 ✅
