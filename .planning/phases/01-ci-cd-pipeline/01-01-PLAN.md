...
must_haves:
  truths:
    ...
    - Build completes successfully and produces Windows amd64 executable
...
4. DO NOT build for GOARCH=386 - Wails does NOT officially support 32-bit Windows (known WebView2 crashes)
...
7. Workflow does NOT include 386 (32-bit) builds
</success_criteria>
