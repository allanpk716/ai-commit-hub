...
<task type="auto">
  ...
  <done>app.go 包含 onSecondInstanceLaunch 方法,调用 runtime.WindowUnminimise 和 runtime.WindowShow,包含错误处理</done>
</task>
